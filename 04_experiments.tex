...
We replace the VLM model in (f) with an adaptive threshold curriculum inspired
...
consistently achieves the highest (or tied-highest) lift success and the lowest
...
the complete seen set, pooled lift success decreases from 83.6\% to 64.6\%,
while the unsafe rate increases from 14.7\% to 39.2\% on the unseen set. This
degradation is primarily driven by an increase in harmful collisions from
4.7\% to 18.8\%, whereas object escape rises from 8.1\% to 15.8\%. Among
