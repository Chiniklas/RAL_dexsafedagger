...
alongside pooled results over the complete sets of 16 seen and 6 unseen objects.
...
the complete seen set, pooled lift success decreases from 86.2\% to 63.8\%,
while the unsafe rate increases from 21.2\% to 34.8\% on the unseen set. This
degradation is primarily driven by an increase in harmful collisions from
9.3\% to 20.1\%, whereas object escape rises only from 11.9\% to 13.8\%. Among
