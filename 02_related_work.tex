...
Policy distillation transfers behavior from a high-capacity teacher to a compact student and has been adopted from
...
Many imitation learning methods operate offline, using a fixed dataset of expert demonstrations to match the expert
