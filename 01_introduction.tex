...
\begin{itemize}
    \item We propose a semantics-aware, safety-sensitive framework for
    ...
    semantic information from a VLM calibrates the gate's operating point.
    ...
    \item We empirically demonstrate that our semantics-aware intervention
    framework, which combines disagreement and success-value prediction,
