...
\begin{itemize}
    ...
    a mixed intervention mechanism that combines teacher--student action disagreement with a Q-value-based risk
    predictor for proactive teacher takeover in high-risk regions.
    ...
    \item We empirically demonstrate that combining disagreement and risk prediction substantially reduces unsafe
