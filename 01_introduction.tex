...
Dexterous hands enable multi-finger grasping~\cite{brahmbhatt2019contactgrasp},
in-hand reorientation~\cite{chen2022system,andrychowicz2020learning}, and precise
control~\cite{luo2025precise}, but their high-dimensional action spaces and
complex contact dynamics make policy learning difficult. RL
methods~\cite{rajeswaran2017learning,andrychowicz2020learning,akkaya2019solving,petrenko2023dexpbt}
exploit parallel simulation and high-fidelity physics to learn controllers that
generalize across objects and tasks. Yet they mainly optimize task success,
leaving collisions, forceful object ejection, and unstable hand
postures~\cite{liu2023safe,yu2022dexterous} insufficiently constrained. These
failures reduce training efficiency and pose deployment risks, making safe,
efficient exploration a central challenge.
...
skill distillation has become a widely adopted paradigm in recent years. The
...
deployment.
Skill distillation reduces reliance on accurate state estimation and allows
