...
\begingroup
\color{red}
\noindent\textbf{TODO: Revise the contributions below.}

The contributions of this work are summarized as follows:
\begin{itemize}
    \item We propose \methodname (\methodfullname), a VLM-guided,
    ...
    a mixed intervention policy that combines teacher--student action
    disagreement with a Bellman success-value critic trained from lift-success
    labels. Low predicted success triggers proactive teacher takeover, while
    VLM guidance calibrates the gate's operating point.
    ...
    unsafe-episode rate during early training. It also lowers this rate by about
    \textbf{5 percentage points} on average relative to disagreement-only
    SafeDAgger.
\end{itemize}
\endgroup
