...
\begin{itemize}
    ...
    with a success-value critic. Low predicted success triggers teacher takeover,
    while the VLM reasons about scene-level safety from rollout statistics and
    ...
    disagreement, risk prediction, and VLM-guided intervention policy adaptation,
